<template>
  <div>
    ...
    <button @click="openModal" class="btn btn-outline btn-sm">
    ...
    <div v-if="showModal" class="modal modal-open">
      <div class="modal-box">
        <h3 class="font-bold text-lg mb-4">Importar Clientes via CSV</h3>
        ...
        <div class="form-control w-full mb-4">
          ...
          >
            <div v-if="!selectedFile">
              ...
              <p class="text-gray-600 mb-2">Arraste seu arquivo CSV aqui ou</p>
              <button type="button" @click="$refs.fileInput.click()" class="btn btn-outline btn-sm">
                Selecionar arquivo
              </button>
            ...
            <div v-else class="text-green-600">
              ...
              <button @click="selectedFile = null" class="btn btn-ghost btn-xs mt-2">
                Remover arquivo
              </button>
            </div>
          </div>
        ...
        <div class="modal-action">
          <button @click="closeModal" class="btn btn-ghost" :disabled="isImporting">
            Cancelar
          </button>
          <button 
            @click="importCsv" 
